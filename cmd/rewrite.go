...
func (c *RewritterFuncs) FilterPkgs(g inspect.Global) func(func(p inspect.Pkg, pkgFlag PkgFlag) bool) {
...
func (c *RewritterFuncs) BeforeCopy(g inspect.Global, session inspect.Session) {
	if c.BeforeCopyFn == nil {
		return
	}
	c.BeforeCopyFn(g, session)
}
func (c *RewritterFuncs) GenOverlay(g inspect.Global, session inspect.Session) map[string]*Content {
...
func GenRewriteV2(args []string, rootDir string, rw Rewritter, pkgRw inspect.Visitor, opts *GenRewriteOptions) (res *GenRewriteResult) {
